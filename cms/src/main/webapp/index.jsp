		...
		<nav class="navbar-default navbar-static-side" role="navigation">
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="side-menu">
					...
					<li><a class="J_menuItem" href="index.htm"> <i
							class="fa fa-home"></i> <span class="nav-label">首页</span>
					</a></li>
					<li><a href="#"><i class="fa fa-desktop"></i> <span
							class="nav-label">菜单管理</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="html/system/menu/group.html">菜单组管理</a>
							</li>
							<li><a class="J_menuItem" href="html/system/menu/index.html">菜单管理</a>
							</li>
							<li><a class="J_menuItem"
								href="html/system/menu/permission.html">权限配置</a></li>
						</ul></li>
					<li><a href="#"> <i class="fa fa-user-o"></i> <span
							class="nav-label">用户管理</span><span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="html/system/user/index.html">用户管理</a>
							</li>
							<li><a href="#"> <span class="nav-label">角色管理</span><span
									class="fa arrow"></span></a>
								<ul class="nav nav-third-level">
									<li><a class="J_menuItem"
										href="html/system/user/role.html">角色管理</a></li>
									<li><a class="J_menuItem"
										href="html/system/user/role_permission.html">权限管理</a></li>
								</ul></li>
						</ul></li>
					<li><a href="#"><i class="fa fa-cog"></i> <span
							class="nav-label">系统配置</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem"
								href="html/system/system/param.html">参数配置</a></li>
							<li><a class="J_menuItem" href="form_file_upload.html">系统维护</a>
							</li>
						</ul></li>
				</ul>
			</div>
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
						...
						<li class="dropdown"><a class="dropdown-toggle count-info"
							...
							<ul class="dropdown-menu dropdown-messages">
								<li class="m-t-xs">
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle-thumb" src="data/images/head1.jpg">
										</a>
								...
								<li>
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle-thumb" src="data/images/head3.jpg">
										</a>
										<div class="media-body ">
			...
			<div class="row J_mainContent" id="content-main">
				<iframe id="J_iframe" width="100%" height="100%"
					src="html/index.html" frameborder="0" data-id="index_v1.html"
					seamless></iframe>
			</div>
		</div>
	</div>
