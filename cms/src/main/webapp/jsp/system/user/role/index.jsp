	...
	<div class="row">
		<div class="col-sm-12">
			<div class="btn-group hidden-xs" role="table">
				<a href="javascript:void(0)" onclick="Role.openLayer('添加','addDiv');" class="btn btn-w-m btn-info">添加</a>
			</div>
	...
	<div class="row">
		<form method="post" class="form-horizontal">
			...
			<div style="text-align: center;" class="form-group">
				<a href="javascript:void(0)" class="btn btn-w-m btn-info" onclick="Role.add()">保存</a>
				<a href="javascript:void(0)" class="btn btn-w-m btn-default" onclick="Role.closeLayer();">取消</a>
			</div>
		</form>
	</div>
</div>
<div id="editDiv" class="wrapper wrapper-content" style="display: none;overflow: hidden;">
	<div class="row">
		<form method="post" class="form-horizontal">
			...
			<div style="text-align: center;" class="form-group">
				<a href="javascript:void(0)" class="btn btn-w-m btn-info" onclick="Role.edit()">保存</a>
				<a href="javascript:void(0)" class="btn btn-w-m btn-default" onclick="Role.closeLayer();">取消</a>
			</div>
		</form>
	</div>
