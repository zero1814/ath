...
function operation(value, row, index) {
	...
	html +='<a href="javascript:void(0)" style="margin: 5px;" class="btn btn-info btn-sm">权限</a>';
	html += '<a onclick="Role.openEdit(\''+code+'\',\''+name+'\');" style="margin: 5px;" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> 编辑 </a> ';
	html += '<a onclick="Role.del(\''+code+'\');" style="margin: 5px;" class="btn btn-info btn-sm"><i class="fa fa-trash-o"></i> 删除 </a> ';
	html += '</div>';
	return html;
}