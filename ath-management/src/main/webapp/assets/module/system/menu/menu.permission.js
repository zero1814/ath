...
function operation(value, row, index) {
	...
	html += '<a onclick="MenuPermission.openLayer($(\'#editLayer\'));" style="margin: 5px;" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i> 编辑 </a> ';
	html += '<a onclick="MenuPermission.del();" style="margin: 5px;" class="btn btn-info btn-sm"><i class="fa fa-trash-o"></i> 删除 </a> ';
	html += '</div>';
	return html;
}