...
var DbTaleColumn = {
	...
	data : function() {
		$("#table").bootstrapTable({
			url : DbTaleColumn.dataUrl, // 请求后台的URL（*）
			method : 'get', // 请求方式（*）
			dataType : "json",
			...
			sortOrder : "desc", // 排序方式
			queryParams : DbTaleColumn.initDataParam,// 传递参数（*）
			...
			columns : DbTaleColumn.columnsArray
		});
	},
