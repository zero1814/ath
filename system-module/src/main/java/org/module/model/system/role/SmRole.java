...
public class SmRole extends BaseModel {
	...
	@Attribute(name = "permissions", description = "角色对应权限结果集")
	private List<SmRolePermission> permissions;

	public List<SmRolePermission> getPermissions() {
		return permissions;
	}

	public void setPermissions(List<SmRolePermission> permissions) {
