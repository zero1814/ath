		...
		<div class="col-sm-12">
			<form method="get" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<a style="float: right;" href="javascript:void(0)" onclick="Page.search();" class="btn btn-w-m btn-info">查询</a>
					</div>
				</div>
			</form>
		</div>
	...
	<div class="row">
		<div class="col-sm-12">
			<div class="btn-group hidden-xs" role="table">
				<a href="system/menu/page/addindex.htm" class="btn btn-w-m btn-info">添加</a>
			</div>
