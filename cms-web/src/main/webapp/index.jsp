...
<html>
	<head>
		...
		<script src="assets/plugins/metisMenu/js/metisMenu.min.js" type="text/javascript"></script>
		<script src="assets/plugins/jquery/plugins/slimscroll/js/jquery.slimscroll.min.js" type="text/javascript"></script>
		<script src="assets/plugins/pace/1.0.0/pace.min.js" type="text/javascript"></script>
		<script src="assets/commons/js/usepublic.js" type="text/javascript"></script>
	</head>
		...
		<div id="wrapper">
					...
					<div id="page-wrapper" class="gray-bg dashbard-1">
						...
						<div class="row J_mainContent" id="content-main">
							<iframe id="J_iframe" width="100%" height="100%" src="subindex.htm" frameborder="0" data-id="subindex.htm" seamless></iframe>
						</div>
					</div>
					<!--右侧部分结束-->
		</div>
<script src="assets/commons/js/common.js" type="text/javascript"></script>
<script src="assets/commons/js/content.js" type="text/javascript"></script>
<script src="assets/commons/js/index.js" type="text/javascript"></script>
</body>
</html>
