package org.module.service.shiro.impl;
...
import org.module.commons.util.INI4j;
import org.module.helper.commons.LoggerHelper;
import org.module.service.shiro.ShiroManager;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.core.io.ClassPathResource;

/**
 * 
 * 类: ShiroManagerImpl <br>
 * 描述: 动态加载权限 Service <br>
 * 作者: zhy<br>
 * 时间: 2017年7月3日 上午10:22:40
 */
public class ShiroManagerImpl implements ShiroManager {
	...
	/**
	 * 
	 * 方法: getFixedAuthRule <br>
	 * 描述: 从配额文件获取固定权限验证规则串 <br>
	 * 作者: zhy<br>
	 * 时间: 2017年7月3日 上午10:23:53
	 * 
	 * @return
	 */
	private String getFixedAuthRule() {
		...
		try {
			...
			LoggerHelper.error(getClass(), "加载文件出错。file:" + fileName);
		}
	...
	public synchronized void reCreateFilterChains() {
		...
		try {
			...
			LoggerHelper.error(getClass(), "getShiroFilter from shiroFilterFactoryBean error!");
