...
INSERT INTO systemmodule.sm_menu (uid,`code`,`name`,create_user,create_time,update_user,update_time)VALUES(REPLACE (UUID(), '-', ''),'SM000001','系统相关','admin',now(),'admin',now());
INSERT INTO systemmodule.sm_menu (uid,`code`,`name`,create_user,create_time,update_user,update_time)VALUES(REPLACE (UUID(), '-', ''),'SM000002','商品相关','admin',now(),'admin',now());
INSERT INTO systemmodule.sm_menu (uid,`code`,`name`,create_user,create_time,update_user,update_time)VALUES(REPLACE (UUID(), '-', ''),'SM000003','商户相关','admin',now(),'admin',now());
INSERT INTO systemmodule.sm_menu (uid,`code`,`name`,create_user,create_time,update_user,update_time)VALUES(REPLACE (UUID(), '-', ''),'SM000004','订单相关','admin',now(),'admin',now());
INSERT INTO systemmodule.sm_menu (uid,`code`,`name`,create_user,create_time,update_user,update_time)VALUES (REPLACE (UUID(), '-', ''),'SM000005','活动相关','admin',now(),'admin',now());